						...
						<td class="forminp forminp-radio" id="sp_formatdiv">
							<fieldset id="post-formats-select">
								<ul>
									...
									<li><input type="radio" name="sp_format" class="post-format" id="post-format-tournament" value="tournament"> <label for="post-format-tournament" class="post-format-icon post-format-tournament"><?php _e( 'Tournament', 'sportspress' ); ?></label></li>
								<br>
							</fieldset>
						</td>
					</tr>
