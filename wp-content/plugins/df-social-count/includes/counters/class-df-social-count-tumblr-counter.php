...
/**
 * DF Social Count Tumblr Counter.
 *
 * @package  DF_Social_Count/Tumblr_Counter
 * @category Counter
 * @author   Dan Fisher
 */
class DF_Social_Count_Tumblr_Counter extends DF_Social_Count_Counter {
	...
	public function get_view( $settings, $total ) {
		...
		$tumblr_txt      = ! empty( $settings['tumblr_txt'] ) ? $settings['tumblr_txt'] : __( 'Tumblr', 'df-social-count' );

		return $this->get_view_item( $tumblr_hostname, $total, __( 'followers', 'df-social-count' ), $tumblr_txt, $settings );
	}
}
