...
/**
 * DF Social Count Twitter Counter.
 *
 * @package  DF_Social_Count/Twitter_Counter
 * @category Counter
 * @author   Dan Fisher
 */
class DF_Social_Count_Twitter_Counter extends DF_Social_Count_Counter {
	...
	public function get_view( $settings, $total ) {
		...
		$twitter_txt  = ! empty( $settings['twitter_txt'] ) ? $settings['twitter_txt'] : __( 'Twitter', 'df-social-count' );

		return $this->get_view_item( 'https://twitter.com/' . $twitter_user, $total, __( 'followers', 'df-social-count' ), $twitter_txt, $settings );
	}
}
