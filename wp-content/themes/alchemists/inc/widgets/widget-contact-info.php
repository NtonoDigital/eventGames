...
class Alchemists_Widget_Contact_Info extends WP_Widget {
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'email_1' ) ); ?>"><?php esc_html_e( '1st Email, Link or Phone:', 'alchemists' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'icon_1' ) ); ?>"><?php esc_html_e( '1st Custom Icon:', 'alchemists' ); ?></label>
			...
			<p class="help"><?php _e( 'Add your custom icon, e.g. <code>&lt;i class="fa fa-user"&gt;&lt;/i&gt;</code> or <code>&lt;img src="PATH_TO_IMAGE" /&gt;</code>', 'alchemists'); ?></p>
		</p>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'email_2' ) ); ?>"><?php esc_html_e( '2nd Email, Link or Phone:', 'alchemists' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'icon_2' ) ); ?>"><?php esc_html_e( '2nd Custom Icon:', 'alchemists' ); ?></label>
