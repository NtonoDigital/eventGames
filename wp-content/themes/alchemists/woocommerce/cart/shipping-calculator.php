...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<?php printf( '<p><a href="#" class="btn btn-default btn-xs shipping-calculator-button">%s</a></p>', esc_html( ! empty( $button_text ) ? $button_text : __( 'Calculate shipping', 'alchemists' ) ) ); ?>
			...
			<div class="form-group form-group--sm" id="calc_shipping_state_field">
				<?php
					...
					if ( is_array( $states ) && empty( $states ) ) {
						?>
						<input type="hidden" name="calc_shipping_state" id="calc_shipping_state" placeholder="<?php esc_attr_e( 'State / County', 'alchemists' ); ?>" />
						<?php
						...
						?>
						<input type="text" class="form-control" value="<?php echo esc_attr( $current_r ); ?>" placeholder="<?php esc_attr_e( 'State / County', 'alchemists' ); ?>" name="calc_shipping_state" id="calc_shipping_state" />
						<?php
					}
				?>
			</div>
