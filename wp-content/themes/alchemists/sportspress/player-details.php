...
if ( $show_name ):
	$common[ esc_html__( 'Name', 'sportspress' ) ] = $player->post->post_title;
endif;
...
if ( $show_nationality ):
	...
	if ( $nationalities && is_array( $nationalities ) ):
		...
		endforeach;
		$common[ esc_html__( 'Nationality', 'sportspress' ) ] = implode( '<br>', $values );
	endif;
endif;
...
if ( $show_positions ):
	...
	if ( $positions && is_array( $positions ) ):
		...
		endforeach;
		$common[ esc_html__( 'Position', 'sportspress' ) ] = implode( ', ', $position_names );
	endif;
endif;
...
if ( $show_leagues ):
	...
	if ( $leagues && ! is_wp_error( $leagues ) ):
		...
		$data[ esc_html__( 'Leagues', 'sportspress' ) ] = implode( ', ', $terms );
	endif;
endif;
...
if ( $show_seasons ):
	...
	if ( $seasons && ! is_wp_error( $seasons ) ):
		...
		$data[ esc_html__( 'Seasons', 'sportspress' ) ] = implode( ', ', $terms );
	endif;
endif;
